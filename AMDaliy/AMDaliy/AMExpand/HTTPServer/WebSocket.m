...
//    size_t payloadLength = [msgData isKindOfClass:[NSString class]] ? [(NSString *)msgData lengthOfBytesUsingEncoding:NSUTF8StringEncoding] : [msgData length];
//
...
//        unmasked_payload = (uint8_t *)[msgData bytes];
//    } else if ([msgData isKindOfClass:[NSString class]]) {
